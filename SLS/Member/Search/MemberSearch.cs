...
namespace SLS.Member.Search
{
    public partial class MemberSearch : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            //SLS.Static.parameters.Add("@MemberTypeID", txtMember.Text.ToString());
